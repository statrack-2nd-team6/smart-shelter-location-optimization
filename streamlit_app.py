...
with tab2:
    ...
    with col1:
        ...
        if show_all:
            ...
            df_to_show = df_sorted.head(top_n)
...
with tab3:
    ...
    fig = px.scatter(
        seoul_df.sample(min(1000, len(seoul_df))),  # 샘플링 for performance
        x='cai',
        y='ridership',
        color='priority',
        size='priority',
